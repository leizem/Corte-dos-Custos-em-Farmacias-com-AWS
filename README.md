...
Período de Execução: Janeiro 2025 - Maio 2025
...
o	EC2: 45% do total de gastos mensais
o	RDS: 20% do total de gastos mensais
o	S3: 15% do total de gastos mensais
o	CloudFront: 10% do total de gastos mensais
o	Outros serviços: 10% do total de gastos mensais
•	Padrões de Uso Identificados:
o	Picos de utilização entre 9h-18h nos dias úteis
o	Redução de 70% na demanda durante finais de semana
o	Variações sazonais relacionadas ao ciclo comercial da empresa
3.1.3 Implementação Detalhada
Configuração de Dashboards Personalizados: Foram criados dashboards específicos para diferentes níveis organizacionais:
...
Sistema de Alertas e Notificações: Implementação de sistema automatizado de alertas para:
...
Políticas de Tagging: Estabelecimento de política obrigatória de tagging para todos os recursos:
...
Integração com CloudWatch: Foram criados dashboards específicos para monitoramento do Auto Scaling com alertas proativos:
...
Impacto nos Custos: Com isso, a empresa evitou a necessidade de manter servidores constantemente ativos sem utilização, otimizando o uso dos recursos computacionais e reduzindo significativamente os custos fixos com infraestrutura. A economia mensal atingiu 34% em comparação ao modelo anterior de capacidade fixa.
...
Fase 1 - Prova de Conceito: Migração inicial do sistema de processamento de imagens como piloto, validando:
•	Padrões de arquitetura serverless
•	Ferramentas de deployment e monitoring
•	Processos de troubleshooting e debugging
Fase 2 - Migração de APIs: Conversão das APIs de integração e notificações:
...
Fase 3 - Processamento Batch: Migração dos processos de análise de logs:
